...
int main(){
    ...
    printf("---------------------------------\n");
    printf("\n");
    printf("Escolha dentre as opcoes abaixo qual os 2 metodos de comparacao!(Envie o 1 e depois o segundo)\n");
    printf("\n");
    printf("- Populacao                   (digite: 0)\n- area                        (digite: 1)\n- PIB                         (digite: 2)\n- numero de pontos turisticos (digite: 3)\n- densidade populacional      (digite: 4)\n- PIB percapita               (digite: 5)\n- Super poder                 (digite: 6)\n");
    scanf("%d", &comp1);
    scanf("%d", &comp2);
    
    if (comp1 == comp2){
        printf("Voce escolheu 2 metodos de comparacao iguais, por favor escolha metodos diferentes!\n");
    ...
    switch(comp1){
        ...
        case 3:
            ...
            buffer1 = carta1.nTuristicos;
            buffer2 = carta2.nTuristicos;
        ...
        case 4:
            ...
            buffer1 = carta1.densidadePOP * -1;
            buffer2 = carta2.densidadePOP * -1;
        ...
        case 5:
            ...
            buffer1 = carta1.PIBper;
            buffer2 = carta2.PIBper;
        ...
        case 6:
            ...
            buffer1 = carta1.super;
            buffer2 = carta2.super;
    ...
    switch(comp2){
        ...
        case 0:
            ...
            printf("carta 1 - %s (%s): %d habitantes\n", carta1.cidade,carta1.estado,carta1.pop);
            printf("carta 2 - %s (%s): %d habitantes\n", carta2.cidade,carta2.estado,carta2.pop);
            buffer1 = buffer1 + carta1.pop;
            buffer2 = buffer2 + carta2.pop;
                if(carta1.pop > carta2.pop){
                    printf("Resultado: carta 1 (%s) venceu!", carta1.cidade);
                }else{
                    printf("Resultado: carta 2 (%s) venceu!", carta2.cidade);
        ...
        case 1:
            ...
            printf("carta 1 - %s (%s): %0.2f km2\n", carta1.cidade,carta1.estado,carta1.area);
            printf("carta 2 - %s (%s): %0.2f km2\n", carta2.cidade,carta2.estado,carta2.area);
            buffer1 = buffer1 + carta1.area;
            buffer2 = buffer2 + carta2.area;
                if(carta1.area > carta2.area){
                    printf("Resultado: carta 1 (%s) venceu!\n------------------------------------", carta1.cidade);
                }else{
                    printf("Resultado: carta 2 (%s) venceu!\n------------------------------------", carta2.cidade);
        ...
        case 2:
            ...
            printf("carta 1 - %s (%s): %0.2f R$\n", carta1.cidade,carta1.estado,carta1.PIB);
            printf("carta 2 - %s (%s): %0.2f R$\n", carta2.cidade,carta2.estado,carta2.PIB);
            buffer1 = buffer1 + carta1.PIB;
            buffer2 = buffer2 + carta2.PIB;
                if(carta1.PIB > carta2.PIB){
                    printf("Resultado: carta 1 (%s) venceu!\n------------------------------------", carta1.cidade);
                }else{
                    printf("Resultado: carta 2 (%s) venceu!\n------------------------------------", carta2.cidade);
        ...
        case 3:
            ...
            printf("carta 1 - %s (%s): %d Pontos turisticos\n", carta1.cidade,carta1.estado,carta1.nTuristicos);
            printf("carta 2 - %s (%s): %d Pontos turisticos\n", carta2.cidade,carta2.estado,carta2.nTuristicos);
            buffer1 = buffer1 + carta1.nTuristicos;
            buffer2 = buffer2 + carta2.nTuristicos;
                if(carta1.nTuristicos > carta2.nTuristicos){
                    printf("Resultado: carta 1 (%s) venceu!\n------------------------------------", carta1.cidade);
                }else{
                    printf("Resultado: carta 2 (%s) venceu!\n------------------------------------", carta2.cidade);
        ...
        case 4:
            printf("Comparacao de cartas (Atributo: Densidade populacional)\n");
            printf("carta 1 - %s (%s): %0.2f hab/km2\n", carta1.cidade,carta1.estado,carta1.densidadePOP);
            printf("carta 2 - %s (%s): %0.2f hab/km2\n", carta2.cidade,carta2.estado,carta2.densidadePOP);
            buffer1 = buffer1 - carta1.densidadePOP;
            buffer2 = buffer2 - carta2.densidadePOP;
                if(carta1.densidadePOP < carta2.densidadePOP){
                    printf("Resultado: carta 1 (%s) venceu!\n------------------------------------", carta1.cidade);
                }else{
                    printf("Resultado: carta 2 (%s) venceu!\n------------------------------------", carta2.cidade);
        ...
        case 5:
            ...
            printf("carta 1 - %s (%s): %0.2f R$\n", carta1.cidade,carta1.estado,carta1.PIBper);
            printf("carta 2 - %s (%s): %0.2f R$\n", carta2.cidade,carta2.estado,carta2.PIBper);
            buffer1 = buffer1 + carta1.PIBper;
            buffer2 = buffer2 + carta2.PIBper;
                if(carta1.PIBper > carta2.PIBper){
                    printf("Resultado: carta 1 (%s) venceu!\n------------------------------------", carta1.cidade);
                }else{
                    printf("Resultado: carta 2 (%s) venceu!\n------------------------------------", carta2.cidade);
        ...
        case 6:
            ...
            printf("carta 1 - %s (%s): %0.2f Super poder\n", carta1.cidade,carta1.estado,carta1.super);
            printf("carta 2 - %s (%s): %0.2f Super poder\n", carta2.cidade,carta2.estado,carta2.super);
            buffer1 = buffer1 + carta1.super;
            buffer2 = buffer2 + carta2.super;
                if(carta1.super > carta2.super){
                    printf("Resultado: carta 1 (%s) venceu!\n------------------------------------", carta1.cidade);
                }else{
                    printf("Resultado: carta 2 (%s) venceu!\n------------------------------------", carta2.cidade);
    ...
    if(buffer1 > buffer2){
        printf("\nA carta numero 1 vence a rodada, com o valor de %0.2f!", buffer1);
    }else{
        printf("\nA carta numero 2 vence a rodada, com o valor de %0.2f!", buffer2);
    }
